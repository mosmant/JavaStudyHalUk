...
Math.HuseyinBYCalısma.random()  // 0.0 ile 1.0 arasinda rastgele bir deger verir.
...
greater than or equal to 0.0 and less than 1.0.
    ...
    public static void main(String[] args) {
        ...
        // Math.HuseyinBYCalısma.random(); gives HuseyinBYCalısma.random number between 0.0 and 1.0
        System.out.println("\nHuseyinBYCalısma.random: " + Math.random());
