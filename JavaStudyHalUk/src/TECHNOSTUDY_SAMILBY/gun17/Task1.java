...
public class Task1 {
    // part1. fill array with HuseyinBYCalısma.random values using Random/Math.HuseyinBYCalısma.random, 0 <= HuseyinBYCalısma.random N <= 10
    // arrays size = 10
...
//            System.out.HuseyinBYCalısma.println( "it has zero and ten" );
//        }
        //2. way
