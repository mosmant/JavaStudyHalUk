package TECHNOSTUDY_SAMILBY.gun17;
...
//        //2D array when you dont know
        ...
        //count of rows
//        System.out.HuseyinBYCalısma.println( "rows: " + books.length );
//        System.out.HuseyinBYCalısma.println( "at row index 0 we have column count: " + books[0].length);
//        System.out.HuseyinBYCalısma.println( "at row index 3 we have column count: " + books[3].length);


        //how to access to 2D array
//        System.out.HuseyinBYCalısma.println(books[0][0]);
//        System.out.HuseyinBYCalısma.println(books[0][1]);
//        System.out.HuseyinBYCalısma.println(books[1][0]);
//        System.out.HuseyinBYCalısma.println(books[1][1]);
//        System.out.HuseyinBYCalısma.println(books[1][2]);


        int totalCount = 0;
        //using nested loops
        for (int row = 0; row < books.length; row++) {
//            System.out.HuseyinBYCalısma.println( Arrays.toString(books[row]));
