package TECHNOSTUDY_SAMILBY.gun7;
...
//        System.out.HuseyinBYCalısma.println( s );
//
//        //part1
//        System.out.HuseyinBYCalısma.println( s.replace( "d", "f" ) );
//
//        //part2
//        System.out.HuseyinBYCalısma.println( s.replace( "a", "f" )
//                .replace( "t", "f" )
//                .replace( "e", "f" )
//        );
//
//        //part3
//        System.out.HuseyinBYCalısma.println( s.replaceAll( "[oqr]", "L" ) );
