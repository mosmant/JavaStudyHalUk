...
public class Soru_12 {
    /* 1. Basit bir Kahve makinesi oluşturun.    3 çeşit kahvemiz olsun.
     ...
     String seker oluşturunuz.
         ...
         ONEMLİ !! =   bir int girdisinden sonra String girdisi yapacaksak,araya boş bir nextLine koymamız gerekiyor. (String bosKod = sc.nextLine();    )
          dummy kod ekleyiniz.
    ...
    public static void main(String[] args) {
        ...
        if (hangiKahve.equalsIgnoreCase("Türk kahvesi")) {
            ...
            System.out.println("filitre kahvesi hazırlanıyor");
        } else if (hangiKahve.equalsIgnoreCase("Arap kahvesi")) {
            System.out.println("arap kahvesi hazırlanıyor");
        ...
        System.out.println(hangiKahve + " " + boyut + "hazırlanıyor" + " Afiyet olsun...");
    }
