...
public class A_StringMethods {
    public static void main(String[] args) {
        ...
        System.out.println("----------");
        String textt = "bismillah";
        System.out.println("En sondaki i nun indexi = " + textt.lastIndexOf("i")); //4
        System.out.println("ilk baştan i nun indexi = " + textt.indexOf("i")); //1
        System.out.println("----------");
        /**
         * charAt()
        ...
        System.out.println("**********" + ss.substring(10)); //**********ava gibi olsa
        System.out.println(ss.substring(0, 10).replaceAll("\\D", "*") + ss.substring(10)); //**********ava gibi olsa
        ...
        String ss1 = ss.substring(0, 10); // str'nin ilk 10 karakterini aldik
        ss1=ss1.replaceAll("\\W", "a");
        System.out.println(ss1.replaceAll("\\w", "*")+ss.substring(10)); //**********ava gibi olsa
        System.out.println("----------");
        ...
        System.out.println("trim kullanilmadan once >>>>>> " + ulke + "<<<<<"); //      Almanya
        System.out.println("trim kullanildiktan sonra -->>" + ulke.trim()); //Almanya
        System.out.println("----------");
    ...
    * bir stringe diğerini ekler
     ...
     * */
        ...
        s = s.concat(s2);// yani degiskenin kendisine atama yaparsam degeri kalici degisir
        // s= s+s2; aynı islemi yapardi.
