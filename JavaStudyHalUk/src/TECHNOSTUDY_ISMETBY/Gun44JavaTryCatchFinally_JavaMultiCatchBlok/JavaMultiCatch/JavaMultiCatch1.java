package TECHNOSTUDY_ISMETBY.Gun44JavaTryCatchFinally_JavaMultiCatchBlok.JavaMultiCatch;
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            try {
                ...
                i--; //hatalı giriş yapıldığında for komutunu tekrar etmesi için sayaçı 1 azalttık.
