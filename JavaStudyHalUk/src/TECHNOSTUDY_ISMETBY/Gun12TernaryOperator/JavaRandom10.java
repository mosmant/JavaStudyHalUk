package TECHNOSTUDY_ISMETBY.Gun12TernaryOperator;
...
public class JavaRandom10 {
    public static void main(String[] args) {
        ...
        //  Math.HuseyinBYCalısma.random() -> 0  - 0,9999
        // 0-10 a kadar sayı üretmesini istersem : Math.HuseyinBYCalısma.random*10  ->  0 - 9,999    -> 0-9    -> 10 dahil olması için +1
