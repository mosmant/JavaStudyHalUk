package TECHNOSTUDY_ISMETBY.Gun26_2dArrayListAndUseMethods;
...
public class Java2dArrayList1 {
    public static void main(String[] args) {
        ...
        ArrayList<Integer> arrList = new ArrayList<>(); // istenildiği kadar değişken eklenebilir
        /***********************/
...
//        {
//            System.out.HuseyinBYCalısma.println("matNotlar = " + matNotlar.get(i));
//        }
        ...
        {
            //System.out.HuseyinBYCalısma.println("notlarArrList = " + notlarArrList.get(i));
        ...
        // 2.Ödev
        // HuseyinBYCalısma.Recursive (ÖzYinelemeli Metodlar) konusu google dan ve youtube dan araştırılacak ve öğrenilecek.
    }
