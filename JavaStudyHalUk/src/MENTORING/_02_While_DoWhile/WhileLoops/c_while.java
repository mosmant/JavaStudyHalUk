package MENTORING._02_While_DoWhile.WhileLoops;
...
public class c_while {
    ...
    /*    String pin_sys = "Hu.180884";
        ...
        while (!pin.equals(pin_sys)){
            System.out.HuseyinBYCalısma.println("Yanlış pin kodu girdiniz.");
             pin = scanner.nextLine();
        }
         System.out.HuseyinBYCalısma.println("Başarı ile giriş yapıldı...");
     ...
     /*   String pin_sys = "Hu.180884";
        ...
        do {
            ...
            if (pin_sys.equals(pin)){
                System.out.HuseyinBYCalısma.println("Başarı ile giriş yaptınız...");break;
            }
            else {
                System.out.HuseyinBYCalısma.println("Yanlış pin kodu girdiniz...");
                kalanhak--;
                System.out.HuseyinBYCalısma.println("Kalan hakkınız: " + kalanhak);
            }

    }while (kalanhak > 0);
        if (kalanhak == 0)
        System.out.HuseyinBYCalısma.println("Giriş hakkınız bitti...");
