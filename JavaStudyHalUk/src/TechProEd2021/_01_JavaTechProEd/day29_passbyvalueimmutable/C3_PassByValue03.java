...
public class C3_PassByValue03 {
	...
	public static void degistirSet(List<Integer> list) {
		...
		// java pass bay value kullan�r ancak list deki set method u istisnai olarak 
		// method un i�inde yap�lan de�i�iklikleride kal�c� hale getirir.
		
	}

	public static void degistirFor(List<Integer> list) {
		
		for (Integer each : list) {  // foreach loop ile listenin her eleman�n� tek tek �a���rp 3 fazlas�n� yazd�rd�k
			each+=3;
			System.out.print(each + " ");//13 14 15 
		}
		System.out.println("");
		System.out.println(list);//[10, 11, 12] // listenin kendisinin de�i�medi�ini g�rd�k
	}
