...
public class Scope1 {
	...
	public int sayi; // class'in icinde fakat main method'un disinda olusturulan
              // ve static olmayan variable'lara INSTANCE (Object) variable denir (kapsam-faaliyet alan�)
   ...
   public String soyisim; // default deger null
    ...
    public void method() {
		...
		System.out.println(sayi); // bu method static olmad��� i�in instance variable lara direkt eri�ebilir
		sayi= sayi+20;  // ve bu method i�erisinde ge�erli olmak �zere de�erini de�itirebilir
	}
